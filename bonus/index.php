                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="GET">
                                ...
                                <ul style="list-style: none; padding: 0;">
                                    <li>
                                        <input onchange=onChangeChecked() checked id="has_uppercase_letter" type="checkbox" name="has_uppercase_letter">
                                        <label for="has_uppercase_letter" class="form-label">Uppercase letter</label>
                                    </li>
                                    <li>
                                        <input onchange=onChangeChecked() checked id="has_lowercase_letter" type="checkbox" name="has_lowercase_letter">
                                        <label for="has_lowercase_letter" class="form-label">Lowercase letter</label>
                                    </li>
                                    <li>
                                        <input onchange=onChangeChecked() checked id="has_number" type="checkbox" name="has_number">
                                        <label for="has_number" class="form-label">Number</label>
                                    </li>
                                    <li>
                                        <input onchange=onChangeChecked() checked id="has_symbols" type="checkbox" name="has_symbols">
